  ...
  this.setState({KlickonGalky:event.target.checked})
    ...
    return (
      ...
      <div className="mb-3">
        ...
        <input type={type} className="form-control" id="exampleInputPassword1" placeholder='Напиши тут тот самый пароль-_-' value={this.state.paswordtext} onChange={this.handlePaswordlChange}></input>
      </div>
      <div className="mb-3 form-check">
        <input  type="checkbox" className="form-check-input" id="exampleCheck1" value={this.state.KlickonGalky} onChange={this.FactKlickOnGalky}></input>
